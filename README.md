<h1> Projeto Prático de Programação Orientada a Objetos</h1>
...
<strong>	3.</strong> As CLASSES Curso, Mentoria e Devs são MODELADOS, ou seja, criar seus ATRIBUTOS E MÉTODOS <br>
<strong>	4.</strong> Para que o código fique mais legível e de fácil manutenção, utilizar de algumas das ferramentas que o PARADIGMA DE ORIENTAÇÃO A OBJETOS (POO) nos oferece: ABSTRAÇÃO, ENCAPSULAMENTO, HERANÇA E POLIMORFISMO <br>
...
<br>Paradigma de programação:<br>
...
<br>Linguagens classificadas pela arquitetura da aplicação:<br>
Desktop: C, C++, Object Pascal, Java, etc.<br>
Web: PHP, Ruby, Javascript, Java, etc.<br>
<br>Tipo de execução:<br>
